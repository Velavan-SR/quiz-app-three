    ...
    <>
      ...
      <div id='quiz' className='flex-column'>
        ...
        <div id="buttonspace" className='flex'>
          ...
          <button className="btn" onClick={handlePrev} disabled={currentIndex === 0} style={{backgroundColor:'#3e7eaa',color:'black'}}>
            Prev
          </button>
          ...
          <button className="btn" onClick={handleFinish} style={{backgroundColor:'#a8a8a8'}}>
            Finish
          </button>
